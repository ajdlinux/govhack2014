...
psql postgresql://whereshouldi@localhost -c "alter table sa2 add column hospital_distance float;"
psql postgresql://whereshouldi@localhost -c "update sa2 set hospital_distance = hospital_distance(geom);"