...
<div class="content">
    ...
    <div class="maps-container">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6514.256357583609!2d149.1239506822088!3d-35.277939241407324!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b164d4321f17ccb%3A0x80517a99006294ea!2sEntry+29!5e0!3m2!1sen!2sau!4v1405144978782"></iframe>
    </div>
    ...
    <div class="one-half-responsive">
        ...
        <p>Use the form to send us a message. Its easy to use and we will get back to you really soon!</p>
        <div class="container no-bottom">
                    ...
                    <fieldset>
                        <div class="formValidationError" id="contactNameFieldError">
                            <div class="static-notification-red tap-dismiss-notification">
                                <p class="center-text uppercase">Where Should I?</p>
                            </div>
                        </div>             
                        <div class="formValidationError" id="contactEmailFieldError">
                            <div class="static-notification-red tap-dismiss-notification">
                                <p class="center-text uppercase">whereshouldi.Govhack@gmail.com</p>
                            </div>
                        </div> 
                        <div class="formValidationError" id="contactEmailFieldError2">
                            <div class="static-notification-red tap-dismiss-notification">
                                <p class="center-text uppercase">GPo box 1007 canberra Act 2601</p>
                            </div>
                        </div> 
    ...
    <div class="one-half-responsive last-column">
        <div class="container no-bottom">
            ...
            <p>
                ...
                Canberra ACT 2601</p>
            <p>
                <strong><em>WhereShould I </em>Headquarters</strong><br>
                Entry 29<br>
                Childers St Canberra ACT 2601
            </p>
            <p>
                <strong>Where Should I Pty Ltd</strong><br>
                ABN 11 111 111 111</p>
            <p>
                <strong>Contact Information:</strong><br>
                <a href="#" class="contact-call">Phone: + 0411 675 534</a>
                <a href="#" class="contact-text">Message: + 0411 675 534</a>
                <a href="#" class="contact-mail">Email: WhereShouldI.GovHack@gmail.com</a>
                <a href="#" class="contact-facebook">Fanpage: www.facebook.com/WhereShouldI</a>
                <a href="#" class="contact-twitter">Twitter: @WhereShouldI</a>
            </p>
        </div>
    </div>
